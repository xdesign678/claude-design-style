...
:root {
  ...
  --ease-out: cubic-bezier(0.0, 0.0, 0.2, 1);       /* decelerate — exits */
  --ease-in: cubic-bezier(0.4, 0.0, 1, 1);           /* accelerate — enters */
...
.skeleton-heading { height: 24px; width: 60%; }
.skeleton-avatar { height: 32px; width: 32px; border-radius: 8px; }
.skeleton-block { height: 120px; width: 100%; border-radius: 8px; }
```
